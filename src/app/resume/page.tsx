...
const repositories = [
    {
      title: 'RoundyWorld',
      description: 'Github organization holding some of my projects',
      link: 'https://github.com/RoundyWorld',
    },
    {
      title: 'snekly-front',
      description: 'Frontend for Snekly',
      link: 'https://github.com/RoundyWorld/lovina-app',
...
const jobHistory = [
    {
        ...
        company: "Rasa Legal",
        summary: "Built software to make the process of clearing a criminal record simple and affordable for everyone.",
        detail: [
    ...
    },
    {
        ...
        summary: "Created tools to support biological machine-learning algorythms and research scientists.",
        detail: [
    ...
    },
    {
        ...
        title: "Software Engineer",
        company: "Domo",
        summary: "Piped data from social platforms into Domo's data visualization tools.",
        detail: [
    ...
    },
    {
        ...
        company: "Xactware",
        summary: "Wrote customer-facing and internal documentation for home insurance software.",
        detail: [
